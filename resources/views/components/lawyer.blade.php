<div class="row">
                ...
                <div class="fpw-overlay">
                    <div class="fpwo-wrap">
                        <div class="fpwow-icons">
                            ...
                            <a href="https://www.linkedin.com/in/adeolar-tayo/"><i class="fa fa-linkedin fa-lg"></i></a>
    ...
    <div class="col-lg-4 col-md-6 col-sm-6 mb30 wow fadeInRight" data-wow-delay=".4s">
        <div class="f-profile text-center">
            ...
            <h4>UKAPAI VICTOR AGOZIRIM</h4>
            Entertainment Law Attorney and Business Executive Director
        </div>
    </div>
    <div class="col-lg-4 col-md-6 col-sm-6 mb30 wow fadeInRight" data-wow-delay=".6s">
        <div class="f-profile text-center">
            <div class="fp-wrap f-invert">
                <div class="fpw-overlay">
                    <div class="fpwo-wrap">
                        <div class="fpwow-icons">
                            <a href="#"><i class="fa fa-facebook fa-lg"></i></a>
                            <a href="https://x.com/Ifeoluwatayoo"><i class="fa fa-twitter fa-lg"></i></a>
                            <a href="https://www.linkedin.com/in/adeolar-tayo/" target="_blank">
            ...
            <h4>IFEOLUWATAYOMI ADEOLA ESQ</h4>
            Senior Partner
        </div>
    </div>
</div>