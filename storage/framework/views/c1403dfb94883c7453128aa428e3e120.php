                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2 mb-sm-30 text-center">
                            ...
                            <form name="needForm" id="need_form" class="form-border" method="POST"action="<?php echo e(route('needs.store')); ?>">
                                <?php echo csrf_field(); ?>
                                <div class="field-set">
...
</html><?php /**PATH C:\laragon\www\solicitor\resources\views/legal.blade.php ENDPATH**/ ?>