        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2 mb-sm-30 text-center">
                    <h3>Create News</h3>
                    <form name="contactForm" id="contact_form" class="form-border" method="POST" action="<?php echo e(route('news.store')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="field-set">
...
<!-- Mirrored from www.madebydesignesia.com/themes/justica/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Nov 2024 12:29:25 GMT -->
    ...
    <?php /**PATH C:\laragon\www\solicitor\resources\views/news-create.blade.php ENDPATH**/ ?>